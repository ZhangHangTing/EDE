...
import bupt.zht.EpcInstance;
import bupt.zht.EpcModel;
...
import engin.pubsub.MonitorService;
...
public class ProcessManagement {
    ...
    public void parseMyTestEpmModel(){
        myModel = new EpcModel("model_001");
        myModel.parseEPMLDocument("");
    }
